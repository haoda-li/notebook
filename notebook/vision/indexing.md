...
```python
--8<-- "vision/scripts/indexing.py:dataset"
```
...
```python
--8<-- "vision/scripts/indexing.py:dict"
```
...
```python
--8<-- "vision/scripts/indexing.py:invert"
```
...
```python
--8<-- "vision/scripts/indexing.py:tfidf"
```
