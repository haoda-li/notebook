...
[Sparse Iterative Closest Point](https://lgg.epfl.ch/publications/2014/sparseicp/paper.pdf)[^1]  
<a href="https://github.com/OpenGP/sparseicp">C++ Implementation</a>

[^1]:
    [Sparse Iterative Closest Point](https://lgg.epfl.ch/publications/2014/sparseicp/paper.pdf)
    ```bibtex
    @inproceedings{10.1111/cgf.12178,
...
Check the Notes on  [Registration](./registration.md)
