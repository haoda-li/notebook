...
```python 
--8<-- "animation/scripts/1d_mass_spring.py:fe"
```
...
```python
--8<-- "animation/scripts/1d_mass_spring.py:rk4"
```
...
```python
--8<-- "animation/scripts/1d_mass_spring.py:be"
```
...
```python
--8<-- "animation/scripts/1d_mass_spring.py:sc"
```
...
???quote "Source code"
    ...
    ```python
    --8<-- "animation/scripts/1d_mass_spring.py"
    ```
