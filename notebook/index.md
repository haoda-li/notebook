...
=== "Vision and Graphics"
    ...
    -   [__Learning for 3D Vision__](./cs294173/intro.md)  
        ...
        :fontawesome-solid-user-tie: [Angjoo Kanazawa](https://people.eecs.berkeley.edu/~kanazawa/)
    ...
    -   [__Intro. Image Understanding__](./csc420/linear_filters.md)  
        ...
        :fontawesome-solid-user-tie: [Babak Taati](http://www.cs.toronto.edu/~taati/)
    ...
    -   [__Geometry Processing__](./csc419/introduction.md)   
        ...
        :fontawesome-solid-user-tie: [Alec Jacobson](https://www.cs.toronto.edu/~jacobson/)
    ...
    -   [__Physics-based Animation__](./csc417/introduction.md)  
        ...
        :fontawesome-solid-user-tie: [David I.W. Levin](http://142.93.146.228/researchdb/) 
    ...
    -   [__Computer Graphics and Imaging__](./cs284/sampling.md)  
        ...
        :fontawesome-solid-user-tie: [Ren Ng](https://www2.eecs.berkeley.edu/Faculty/Homepages/yirenng.html), [James F. O'Brien](http://obrien.berkeley.edu/)   
    ...
    -   [__Intro. Computer Graphics__](./csc418/raster_image.md)   
        ...
        :fontawesome-solid-user-tie: [Sarah Kushner](http://www.sarahkushner.com/)

        :fontawesome-solid-link: [Course Site](https://github.com/alecjacobson/computer-graphics-csc317)
...
=== "Machine Learning"
    ...
    - __Neural Networks__  
        CSC413/CSC2516 _(2020W)_

        ---

        :fontawesome-solid-user-tie: [Jimmy Ba](https://jimmylba.github.io/) 
    ...
    - [__Probabilistic Learning and Reasoning__](./csc412/models.md)  
        ...
        :fontawesome-solid-user-tie: [David K. Duvenaud](http://www.cs.toronto.edu/~duvenaud/)
    ...
    - [__Intro. Machine Learning__](./csc311/knn.md)  
        ...
        :fontawesome-solid-user-tie: [Richard Zemel](http://www.cs.columbia.edu/~zemel/)

        :fontawesome-solid-link: [Course Site](https://erdogdu.github.io/csc311_f19/)
...
=== "General Computer Science"
    ...
    - [__Applications of Parallel Computers__](./cs267/communication.md)  
        ...
        :fontawesome-solid-user-tie: [Aydın Buluç](https://people.eecs.berkeley.edu/~aydin/), [James Demmel](https://people.eecs.berkeley.edu/~demmel/), [Laura Grigori](https://who.rocq.inria.fr/Laura.Grigori/)
    ...
    - [__Parallel Programming__](./csc367/hie.md)    
        ...
        :fontawesome-solid-user-tie: [Maryam Mehri Dehnavi](https://www.cs.toronto.edu/~mmehride/)

    - __Principles of Programming Languages__  
        CSC324 _(2022W)_

        ---

        :fontawesome-solid-user-tie: [Gary Baumgartner](http://www.cs.toronto.edu/~gfb/)
    ...
    - [__Enriched Data Structures and Analysis__](./csc265/pq.md)     
        ...
        :fontawesome-solid-user-tie: [Aleksandar Nikolov](https://www.cs.toronto.edu/~anikolov/) 

    - __Enriched Theory of Computation__  
        CSC240 _(2018W)_
    ...
    - [__Databases__](./csc343/ra.md)     
        ...
        :fontawesome-solid-user-tie: Daniela Rosu
...
=== "Statistics"
    ...
    - [__Probability__](./sta347/probability.md)      
        ...
        :fontawesome-solid-user-tie: Gun Ho Jang
    </div>
