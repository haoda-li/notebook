...
--8<-- "graphics/scripts/meshes.py:cube"
```
...
[:simple-threedotjs: Cube Texture Mapping Demo](./assets/meshes/cube.html){ .md-button .md-button--primary target="_blank" }
...
--8<-- "graphics/scripts/meshes.py:sphere"
```
...
[:simple-threedotjs: Sphere Texture Mapping Demo](./assets/meshes/sphere.html){ .md-button .md-button--primary target="_blank" }
