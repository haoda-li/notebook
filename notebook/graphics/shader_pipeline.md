...
--8<-- "graphics/assets/shaders.js:108:116"
```

```glsl title="fragment shader example"
// fragment shader using Blinn Phong shading
--8<-- "graphics/assets/shaders.js:2:5"

--8<-- "graphics/assets/shaders.js:141:154"
```
...
--8<-- "graphics/assets/shaders.js:27:33"
```

```glsl title="Smooth step and improved smooth step"
--8<-- "graphics/assets/shaders.js:37:39"
// The improved version
--8<-- "graphics/assets/shaders.js:43:45"
```

```glsl title="Perlin noise from 3D Seed"
--8<-- "graphics/assets/shaders.js:48:71"
```
...
--8<-- "graphics/assets/shaders.js:217:227"
```
...
[:simple-threedotjs: Shader Demo](./assets/shaders.html){ .md-button .md-button--primary target="_blank" }
