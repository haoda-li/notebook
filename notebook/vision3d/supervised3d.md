...
[Depth Map Prediction from a Single Image using a Multi-Scale Deep Network](https://arxiv.org/abs/1406.2283)[^eigen2014]
...
[Towards Robust Monocular Depth Estimation: Mixing Datasets for Zero-shot Cross-dataset Transfer](https://arxiv.org/abs/1907.01341)[^ranftl2022]
...
An additional regularization term (multiscale gradient matching introduced by [MegaDepth](https://arxiv.org/abs/1804.00607)[^li2018]) is also adapted.

## Depth Estimation on Videos

[Robust Consistent Video Depth Estimation](https://robust-cvd.github.io/)[^kopf2021]
...
Vector Representation for Objects](https://arxiv.org/abs/1603.08637)[^girdhar2016], [Pix2vox](https://arxiv.org/abs/1901.11153)[^xie2019]) uses an encoder-decoder structure to encode 2D images and decode to 3D voxel volumes. Following works uses octrees to allow hierarchical approach to save computations. 
...
- Signed distance ([DeepSDF](https://arxiv.org/abs/1901.05103)[^park2019]), the closest distance to the surface. positive distance means outside of the surface and negative means inside. Surface at 0-level..
- Occupancy function or Inside/outside score ([Occupancy Networks](https://arxiv.org/abs/1812.03828)[^mescheder2019], [Learning Implicit Fields for Generative Shape Modeling](https://arxiv.org/abs/1812.02822)[^chen2019]), $0$ if outside the shape, $1$ is inside. Surface at $\frac{1}{2}$-level. 
...
[AtlasNet: A Papier-Mache Approach to Learning 3D Surface Generation](https://arxiv.org/abs/1802.05384)[^groueix2018]
...
[^girdhar2016]:
    [Learning a Predictable and Generative Vector Representation for Objects](https://arxiv.org/abs/1603.08637)
    ```bibtex
