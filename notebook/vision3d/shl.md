...
[:simple-threedotjs: Sphere Sampling Demo](./assets/sphere_sample.html){ .md-button .md-button--primary target="_blank" }
...
```js title="ALP"
--8<-- "vision3d/assets/sh.html:71:97"
```
...
```js title="SH"
--8<-- "vision3d/assets/sh.html:99:111"
```

[:simple-threedotjs: Spherical Harmonic Lighting Demo](./assets/sh.html){ .md-button .md-button--primary target="_blank" }
